...
const DiscoverMain = () => {
  ...
  return (
    <div className="flex rounded-full border-grey  justify-center mx-4">
      <div className="w-full max-w-[1150px]">
        ...
        <div className="flex rounded-full border-black border-2 bg-blue-200 justify-center items-center gap-10 p-5 mb-5 border-gray-200 bg-white w-full">
          <span
